...
if (isset($_POST["btnDispatch"]))
{
	...
	if (!$stmt->bind_param('ssssss', $_POST['ylcallerName'], $_POST['ylcontactNo'], $_POST['incidenttype'], $_POST['Location'], $_POST['incidentDesc'], $incidentstatus))
...
<tr>
<td>Contact No :</td>
<td><?php echo $_POST['ylcontactNo']?><input type="hidden" name="ylcontactNo" id="ylcontactNo" value="<?php echo $_POST['ylcontactNo']?>"></td>
</tr>
<tr>
<td>Location :</td>
